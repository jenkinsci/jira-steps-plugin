...
public class NewVersionStepTest {
	...
	public void setup() {
		...
		stepExecution = spy(new NewVersionStep.Execution());
		...
		when(jiraServiceMock.createVersion(any())).thenReturn(builder.successful(true).code(200).message("Success").build());
